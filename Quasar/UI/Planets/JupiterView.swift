        ...
        ZStack {
            ...
            ScrollView {
                ...
                Group {
                    ...
                    planetImageSubtext(text: "Jupiter's diameter is one order of magnitude smaller (×0.10045) than that of the Sun, and one order of magnitude larger (×10.9733) than that of Earth. The Great Red Spot is roughly the same size as Earth.").padding(.bottom)
                    planetText(text: jupiterSummary2)
                    planetImage(name: "jupiter3").padding(.top)
                    planetImageSubtext(text: "Close up of The Great Red Spot, Taken by the Juno spacecraft, in April 2018.").padding(.bottom)
