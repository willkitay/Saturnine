        ...
        ZStack {
            ...
            ScrollView {
                ...
                Group {
                    ...
                    planetImageSubtext(text: "Saturn's northern polar vortex captured by Cassini. (NASA/JPL-Caltech/Space Science Institute.)").padding(.bottom)
                    planetText(text: saturnSummary2)
                    planetImage(name: "saturn3").padding(.top)
                    planetImageSubtext(text: "This image made available by NASA in April 2017 shows the Cassini spacecraft diving between Saturn and the planet's innermost rings. Cassini was launched in 1997 and reached Saturn in 2004.").padding(.bottom)
